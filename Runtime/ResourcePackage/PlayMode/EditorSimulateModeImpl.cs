...
namespace YooAsset
{
    internal class EditorSimulateModeImpl : IPlayMode, IBundleQuery
    {
        ...
        /// 异步初始化
        /// </summary>
        public InitializationOperation InitializeAsync(ResourceAssist assist, string simulateManifestFilePath,bool isImmediately = false)
        {
            _assist = assist;

            var operation = new EditorSimulateModeInitializationOperation(this, simulateManifestFilePath,isImmediately);
