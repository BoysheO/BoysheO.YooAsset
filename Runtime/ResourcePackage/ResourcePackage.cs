...
namespace YooAsset
{
    public class ResourcePackage
    {
        ...
        /// 异步初始化
        /// </summary>
        public InitializationOperation InitializeAsync(InitializeParameters parameters,bool isImmediately = false)
        {
            ...
            if (_playMode == EPlayMode.EditorSimulateMode)
            {
                ...
                initializeOperation = editorSimulateModeImpl.InitializeAsync(assist, initializeParameters.SimulateManifestFilePath,isImmediately);
            }
