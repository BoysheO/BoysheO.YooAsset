...
namespace YooAsset
{
    public static partial class YooAssets
    {
        ...
        private static YooAssetsDriver _driver => YooAssetsDriver.Instance;
        ...
        public static void Initialize(ILogger logger = null)
        {
            ...
            if (_isInitialize == false)
            {
                ...
                {
                    // 添加远程调试脚本
                    _driver.gameObject.AddComponent<RemoteDebuggerInRuntime>();
                }
#endif
        ...
        public static ResourcePackage GetPackage(string packageName)
        {
            ...
            if (package == null)
                YooLogger.Warning($"Not found resource package : {packageName}");
            return package;
        }
